...
session = AgentSession(
    ...
    llm=google.LLM(model="gemini-1.5-flash"),   # Conversation engine
...
### 6. LLM Choice: Gemini 1.5 Flash

**Decision:** Use Gemini 1.5 Flash for agent conversations
...
- ❌ **Cons:** Less nuanced follow-ups compared to larger models, may miss subtle technical cues
- **When to use Pro models:** Complex code review interviews, senior-level technical depth
