...
def ingest_documents(
    ...
    if not os.getenv("GOOGLE_API_KEY"):
        raise ValueError(
            "GOOGLE_API_KEY environment variable must be set for embeddings"
        )
    ...
    # Create embeddings
    embeddings = GoogleGenerativeAIEmbeddings(model=os.getenv("EMBEDDINGS_MODEL", "models/text-embedding-004"))
